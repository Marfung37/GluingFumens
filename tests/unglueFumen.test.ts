...
describe('unglueFumen', () => {
  test('Fumens with no pieces', () => {
    ...
    // colored diagonal
    expect(unglueFumen('v115@WfA8ReQpReAtReQ4Reg0ReglRewhRewwSeAgH')).toBe(
      'v115@WfA8ReQpReAtReQ4Reg0ReglRewhRewwSeAgH'
    );
    ...
    expect(unglueFumen('v115@/gA8DeA8PeA8AeA8CeC8CeA8BeA8JeAgHvhDAgHAgH?AgHAgH')).toBe(
      'v115@/gA8DeA8PeA8AeA8CeC8CeA8BeA8JeAgH'
    );

    // multipage colored diagonal
    expect(unglueFumen('v115@WfA8ReQpReAtReQ4Reg0ReglRewhRewwSeAgHvhBAg?HAgH')).toBe(
      'v115@WfA8ReQpReAtReQ4Reg0ReglRewhRewwSeAgH'
    );
  });
  ...
  test('Edge cases', () => {
    // weird 6L
    expect(unglueFumen('v115@igG8DeF8DeF8DeF8DeF8BeH8CeG8Je2OJvhEupBJkB?GlBGqBmpB')).toBe(
      'v115@fgi0G8whi0F8whi0F8whi0F8whi0F8h0H8i0G8JeAg?H'
    );
    expect(unglueFumen('v115@igG8DeF8DeF8DeF8DeF8BeH8CeG8Je2OJvhEupBJkB?WlB+qBmpB')).toBe(
      'v115@fgi0G8whi0F8whi0F8whi0F8whi0F8h0H8i0G8JeAg?H'
    );
    expect(unglueFumen('v115@igG8DeF8DeF8DeF8DeF8BeH8CeG8Je2OJvhEJfBWqB?+lBupBmpB')).toBe(
      'v115@fgi0G8whi0F8whi0F8whi0F8whi0F8h0H8i0G8JeAg?H'
    );
    expect(unglueFumen('v115@igG8DeF8DeF8DeF8DeF8BeH8CeG8Je2OJvhEJfBGlB?upBGlBmpB')).toBe(
      'v115@fgi0G8whi0F8whi0F8whi0F8whi0F8h0H8i0G8JeAg?H'
    );

    // weird I piece cut at every mino
    expect(unglueFumen('v115@VgI8AeA8AeG8AeI8LeI8BeH8AeI8TeJEJvhBp+IpEJ')).toBe(
      'v115@VgI8whA8whG8whI8whAewhGexhI8xhH8whI8xhReAg?H'
    );
  });
});
