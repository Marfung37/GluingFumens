...
describe('OperationEncoder', () => {
  test('encode', () => {
    ...
    let op2 = {x: 5, y: 0, type: 'T', rotation: 'spawn'} as Operation;
    let op3 = {x: 1, y: 4, type: 'T', rotation: 'spawn'} as Operation;
    let op4 = {x: 1, y: 0, type: 'S', rotation: 'spawn'} as Operation;
    let op5 = {x: 1, y: 0, type: 'T', rotation: 'reverse'} as Operation;
    let op6 = {x: 5, y: 3, type: 'L', rotation: 'left'} as Operation;
