...
function getNewStart(field, height, x, y, minoPositions) {
    ...
    }, minoPositions[1]); // Initialize with the first pair
...
function glue(x0, y0, field, height, piecesArr, allPiecesArr, totalLinesCleared, visualizeArr, expectedSolutions, visualize) {
...
function glueFumen(customInput, expectedSolutions, visualize) {
